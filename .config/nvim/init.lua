...
-- Variable to track diagnostic display state
...
function _G.toggle_diagnostics()
    if vim.g.diagnostics_visible then
        ...
        -- Enable and show diagnostics
        vim.diagnostic.enable()
        -- Reset diagnostic underlines
...
vim.keymap.set("n", "<leader>td", function()
    ...
    -- Optional: Show a notification of the current state
    if vim.g.diagnostics_visible then
...
-- Disable diagnostics completely on startup
vim.diagnostic.disable()
-- Disable diagnostic underlines on startup
vim.cmd([[highlight DiagnosticUnderlineError gui=none]])
vim.cmd([[highlight DiagnosticUnderlineWarn gui=none]])
vim.cmd([[highlight DiagnosticUnderlineInfo gui=none]])
vim.cmd([[highlight DiagnosticUnderlineHint gui=none]])
